...
public interface CreateJudgeMilestoneResultRequestMapper extends BaseDtoMapper<JudgeMilestoneResultEntity, CreateJudgeMilestoneResultRequest> {
    ...
    JudgeMilestoneResultEntity toEntity(CreateJudgeMilestoneResultRequest dto);
    ...
    CreateJudgeMilestoneResultRequest toDto(JudgeMilestoneResultEntity entity);
