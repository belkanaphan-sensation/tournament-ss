...
public class ActivityController {
    ...
    @Operation(summary = "Начать активность по ID",
            description = "Начать активность может или администратор или судья данной активности")
    ...
    @Operation(summary = "Завершить активность по ID",
            description = "Завершить активность может или администратор или судья данной активности")
